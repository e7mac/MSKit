...
////      [specs removeObjectsForKeys:@[@"default"]];
...
//  }
//  if (spec[@"footerView"]) {
//    if ([spec[@"footerView"][@"class"] isEqualToString:@"loginView"]) {
//      self.footerView = [self loginView];
//    } else if ([spec[@"footerView"][@"class"] isEqualToString:@"skipNextView"]) {
//      self.footerView = [self skipNextView];
//    } else if ([spec[@"footerView"][@"class"] isEqualToString:@"backForwardView"]) {
//      self.footerView = [self backForwardView];
//    } else if ([spec[@"footerView"][@"class"] isEqualToString:@"singleActionFooterView"]) {
//      self.footerView = [self singleActionFooterView];
////    } else if ([spec[@"footerView"][@"class"] isEqualToString:@"loginView"]) {
////      self.footerView = [self loginView];
////    } else if ([spec[@"footerView"][@"class"] isEqualToString:@"loginView"]) {
//    }
//    self.footerView.backgroundColor = [self colorFromHexString:spec[@"footerView"][@"backgroundColor"]];
//  }
//}
//
...
//  } else {
//    [self.pageControl autoPinEdge:ALEdgeBottom toEdge:ALEdgeTop ofView:self.view];
//  }
//}
//
//-(UIView *)loginView
...
//  [v addSubview:login];
//  login.backgroundColor = [UIColor colorWithWhite:0.0 alpha:0.5];
//  [login addTarget:self action:@selector(login) forControlEvents:UIControlEventTouchUpInside];
//  [login autoSetDimension:ALDimensionWidth toSize:300];
...
//  facebook.backgroundColor = [UIColor colorWithWhite:0.0 alpha:0.5];
//  [v addSubview:facebook];
//  [facebook addTarget:self action:@selector(facebook) forControlEvents:UIControlEventTouchUpInside];
//  [facebook autoSetDimension:ALDimensionWidth toSize:300];
//  [facebook autoAlignAxisToSuperviewAxis:ALAxisVertical];
//  [facebook autoPinEdge:ALEdgeTop toEdge:ALEdgeBottom ofView:login withOffset:20];
//  
//  [self.view addSubview:v];
//  return v;
//}
...
//{
//  CGFloat footerHeight = THIN_BAR_HEIGHT*2;
//  UIView *v = [[UIView alloc] initWithFrame:CGRectMake(0, 0, self.view.bounds.size.width, footerHeight)];
//  v.backgroundColor = [UIColor colorWithWhite:1.0 alpha:0.5];
//  [self.view addSubview:v];
//  
